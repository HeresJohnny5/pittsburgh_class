...
class TestCoinChangerKata < Minitest::Test
  ...
  def test_responds_to_currency_hash_with_currency_greater_than_5_less_than_100
  ...
  def test_responds_to_currency_hash_with_currency_greater_than_5_less_than_500
